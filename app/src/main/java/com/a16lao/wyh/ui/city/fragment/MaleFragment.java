...
import com.a16lao.wyh.ui.city.activity.MaleCategoryActivity;
...
public class MaleFragment extends LazyFragment implements View.OnClickListener, OnBannerListener {
    private TextView text_male_rank, text_male_part, text_male_new, text_male_free, text_male_category;
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        text_male_rank = rootView.findViewById(R.id.text_male_rank);
        text_male_part = rootView.findViewById(R.id.text_male_part);
        text_male_new = rootView.findViewById(R.id.text_male_new);
        text_male_free = rootView.findViewById(R.id.text_male_free);
        text_male_category = rootView.findViewById(R.id.text_male_category);
...
//        banner_selection.setPageTransformer(true, new ScaleTransformer());
    ...
    private void setListener() {
        //分类
        text_male_category.setOnClickListener(v ->
            toOtherActivity(MaleCategoryActivity.class, null, false)
        );
    }
