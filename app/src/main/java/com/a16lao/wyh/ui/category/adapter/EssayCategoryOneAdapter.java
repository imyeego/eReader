...
public class EssayCategoryOneAdapter extends SimpleBaseAdapter<String> {
    public EssayCategoryOneAdapter(Context mContext, List<String> list) {
        super(mContext, R.layout.grid_essay_category_item, list);
    }
