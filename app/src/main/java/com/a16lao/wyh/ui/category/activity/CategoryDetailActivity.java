...
import com.a16lao.wyh.ui.city.activity.BookDetailActivity;
...
public class CategoryDetailActivity extends BaseActivity implements CallBack {
    ...
    protected void initData() {
        ...
        list_category_item.setAdapter(new WeekRankAdapter(mActivity, mList));
        list_category_item.setOnItemClickListener((parent, view, position, id) -> {
            toOtherActivity(BookDetailActivity.class, null, false);
        });
    }
