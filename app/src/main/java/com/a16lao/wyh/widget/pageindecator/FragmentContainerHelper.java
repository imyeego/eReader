...
public class FragmentContainerHelper {
    ...
    public FragmentContainerHelper(ViewPagerIndicator magicIndicator) {
        mViewPagerIndicators.add(magicIndicator);
    }
    ...
    public void attachViewPagerIndicator(ViewPagerIndicator magicIndicator) {
        mViewPagerIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (ViewPagerIndicator magicIndicator : mViewPagerIndicators) {
