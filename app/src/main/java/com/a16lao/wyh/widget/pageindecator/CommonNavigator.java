...
public class CommonNavigator extends FrameLayout implements IPagerNavigator
    ...
    private int mMargin = 5;         //左右间距，默认为5dp
    ...
    private void initTitlesAndIndicator() {
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ITitleView v = mAdapter.getTitleView(getContext(), i);
            if (v instanceof View) {
                ...
                lp.leftMargin = DimenUtils.dip2px(getContext(), mMargin);
                lp.rightMargin = DimenUtils.dip2px(getContext(), mMargin);
    ...
    private void preparePositionData() {
        ...
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v != null) {
                ...
                if (v instanceof IMeasurableTitleView) {
                    IMeasurableTitleView view = (IMeasurableTitleView) v;
    ...
    public void onEnter(int index, int totalCount, float enterPercent, boolean leftToRight) {
        ...
        if (v instanceof ITitleView) {
            ((ITitleView) v).onEnter(index, totalCount, enterPercent, leftToRight);
        }
    }
    ...
    public void onLeave(int index, int totalCount, float leavePercent, boolean leftToRight) {
        ...
        View v = mTitleContainer.getChildAt(index);
        if (v instanceof ITitleView) {
            ((ITitleView) v).onLeave(index, totalCount, leavePercent, leftToRight);
        }
    }
    ...
    public void onSelected(int index, int totalCount) {
        ...
        View v = mTitleContainer.getChildAt(index);
        if (v instanceof ITitleView) {
            ((ITitleView) v).onSelected(index, totalCount);
        }
    ...
    public void onDeselected(int index, int totalCount) {
        ...
        View v = mTitleContainer.getChildAt(index);
        if (v instanceof ITitleView) {
            ((ITitleView) v).onDeselected(index, totalCount);
        }
    }

    public ITitleView getPagerTitleView(int index) {
        if (mTitleContainer == null) {
            return null;
        }
        return (ITitleView) mTitleContainer.getChildAt(index);
    }
