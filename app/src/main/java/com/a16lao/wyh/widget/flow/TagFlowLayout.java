...
/**
 * date:   2018/5/30 0030 上午 10:23
 * author: caoyan
 * description:
 */

public class TagFlowLayout extends FlowLayout
        implements FlowAdapter.OnDataChangedListener {
    ...
    private void changeAdapter() {
        ...
        HashSet preCheckedList = mFlowAdapter.getPreCheckedList();
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mFlowAdapter.setSelected(i, adapter.getItem(i))) {
                setChildChecked(i, tagViewContainer);
            }
    ...
    private void setChildChecked(int position, TagView view) {
        ...
        mFlowAdapter.onSelected(position, view.getTagView());
    }

    private void setChildUnChecked(int position, TagView view) {
        view.setChecked(false);
        mFlowAdapter.unSelected(position, view.getTagView());
    }
