...
public class BitmapUtils {
    //压缩质量
    public static void compressQuality(Bitmap bitmap, String outfilePath, int quality) {
    ...
    public static boolean bitmap2File(Bitmap bitmap, String folder, String fileName) {
