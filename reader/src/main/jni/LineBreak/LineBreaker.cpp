...
extern "C"
void Java_com_koolearn_klibrary_linebreak_LineBreaker_init(JNIEnv *env, jobject thiz) {
	init_linebreak();
}

extern "C"
void Java_com_koolearn_klibrary_linebreak_LineBreaker_setLineBreaksForCharArray(JNIEnv *env, jobject thiz, jcharArray data, jint offset, jint length, jstring lang, jbyteArray breaks) {
...
extern "C"
void Java_com_koolearn_klibrary_linebreak_LineBreaker_setLineBreaksForString(JNIEnv *env, jobject thiz, jstring data, jstring lang, jbyteArray breaks) {
