...
import com.koolearn.util.NaturalOrderComparator;

import java.text.Normalizer;
import java.util.HashMap;
import java.util.Map;

public abstract class TitledEntity<T extends TitledEntity<T>> extends MultiSelectableBook implements Comparable<T> {
