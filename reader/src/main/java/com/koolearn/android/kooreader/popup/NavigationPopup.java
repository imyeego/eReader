...
public final class NavigationPopup extends ZLApplication.PopupPanel implements View.OnClickListener {
    ...
    private void createPanel(KooReader activity, RelativeLayout root) {
        ...
        myWindowTop = root.findViewById(R.id.mainmenuwindow);
        init();
        initClick();
    }
    ...
    private void init() {
        mTextViewToc = myWindow.findViewById(R.id.navigation_toc);//目录
        mTextViewFonts = myWindow.findViewById(R.id.navigation_fonts);//设置
        mTextViewProgress = myWindow.findViewById(R.id.navigation_progress);
        mButtonBookMark = myWindowTop.findViewById(R.id.mark);
        mButtonBack = myWindowTop.findViewById(R.id.back);
    }
    ...
    public void onClearWindow(PopEvent event){
        if (myWindow != null){
            myWindow = null;
        }
    }
